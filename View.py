...
class View:
    def __init__(self, top=None):
        ...
        self._img4 = tk.PhotoImage(file="./icons/logos.png")
        ...
        self.progress_scale.place(relx=0.200, rely=0.932, relwidth=0.146, relheight=0.0, height=26, bordermode='ignore')
    ...
    def setup_player(self):
        try:
            ...
            if self.my_player.get_db_status():
                messagebox.showinfo("Success!", "Connection successfully to the DB")
        ...
        self.top.title("NIRVANA-Plug Into The World Of Pure Music!")
        img=tk.PhotoImage(file="./icons/mymusic.png")
    ...
    def play_song(self):
        ...
        try:
            ...
            self.progress_scale.config(from_ =0, to=self.song_length, command=self.move_song)
    ...
    def closewindow(self):
        ...
        if result:
            ...
            messagebox.showinfo("Have a good day ", "Thank you for using NIRVANA")
            self.top.destroy()
    ...
    def add_song_to_favourites(self):
        ...
        try:
            ...
            result = self.my_player.add_songs_to_favourites(song_name)
    ...
    def load_songs_from_favourites(self):
        try:
            ...
            messagebox.showerror("DB Error!", "Song cannot be loaded from favourites.")
